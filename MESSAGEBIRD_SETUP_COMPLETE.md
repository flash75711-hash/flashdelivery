...
1. بعد تسجيل الدخول، اذهب إلى: https://dashboard.messagebird.com/
2. في Dashboard، ابحث عن:
   - **"API Access"** أو
   - **"Settings"** > **"API Access"** أو
   - **"Developers"** > **"API Keys"**
3. ستجد **"API Key"** (يبدأ بحروف وأرقام)
4. انسخ API Key

### الطريقة الثانية: من Developers Portal
...
2. في صفحة Phone settings:
   ...
   - أدخل:
     - **Messagebird API Key**: (الذي نسخته من MessageBird)
     - **Messagebird From**: (قد يكون مطلوباً - جرب رقم هاتف أو اتركه فارغاً)
...
4. **تحقق من رقم "From"**:
   - إذا طلب Supabase رقم "From"، تأكد من إدخاله
   - أو جرب شراء رقم من MessageBird

---

## 📋 ملخص الخطوات:

1. ✅ سجل في MessageBird: https://www.messagebird.com/
